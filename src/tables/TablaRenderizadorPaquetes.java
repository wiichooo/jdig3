 ...
 * @author Luis
 */
public class TablaRenderizadorPaquetes implements TableCellRenderer {
...
//            }
        ...
        if (column == 0) {
            ...
            etiqueta.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
            etiqueta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/16/kthememgr.png")));
            // Color colorete = (Color) value;
            // etiqueta.setBackground(colorete);
